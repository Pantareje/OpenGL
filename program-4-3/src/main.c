...
static vec3 cubePos, pyramidPos;
...
static bool init(GLFWwindow *window)
{
	...
	glm_vec3_copy((vec3){ 0.0f, 0.0f, 10.0f }, cameraPos);

	glm_vec3_copy((vec3){ -1.5f, -1.5f, +1.5f }, cubePos);
	glm_vec3_copy((vec3){ +1.5f, +1.5f, -1.5f }, pyramidPos);
...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(600, 600, "Capítulo 4 - Programa 3", NULL, NULL);
	if (!window) {
